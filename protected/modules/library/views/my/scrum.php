	<ul class="pagination" style="margin:5px auto 5px auto;">
		  	<li><a href="#" onclick="loadScrumPage(<?php echo $page["currentPage"] ?>)">刷新</a></li>
		  	<li><a href="#" onclick="loadScrumPage(0)">&iota;&lsaquo;</a></li>
		  	<li><a href="#" onclick="loadScrumPage(<?php echo $page["currentPage"]<1?0:$page["currentPage"]-1 ?>)">&laquo;</a></li>
			<?php 
			...
			?>
		  	<li <?php echo $pgclass ?>><a href="#" onclick="loadScrumPage(<?php echo $pageNum ?>)"><?php echo $pageNum+1 ?><span class="sr-only">(current)</span></a></li>
		  	<?php 
		  		}
		  	?>
		  	<li><a href="#" onclick="loadScrumPage(<?php echo $page["currentPage"]>=$page["pageCount"]-1?$page["pageCount"]-1:$page["currentPage"]+1 ?>)">&raquo;</a></li>
		  	<li><a href="#" onclick="loadScrumPage(<?php echo $page["pageCount"]-1 ?>)">&rsaquo;&iota;</a></li>
	</ul>
...
<table class="table table-condensed table-hover table-striped">
	...
	<tr>
		...
		<td><a href="<?php echo Yii::app()->createUrl("library/search/cancelWaiting",array("book_id"=>$data->book_id,)) ?>" onclick='loadScrumPage(<?php echo $page["currentPage"] ?>)' target="_blank" role="button" class="btn btn-warning btn-xs"> Cancel </a></td>
	</tr>
	<?php 
		}
	?>
