	<form id="books_edit" action="<?php echo Yii::app()->createUrl("library/edit/edit") ?>" method="post" enctype="multipart/form-data" class="form-horizontal" role="form" style="margin-top:10px;">
			...
			<div class="form-group">
				...
				<div class="col-sm-7">
					<select class="form-control" id="location_building" name="Books[location_building]">
					  <option value="0" <?php echo $ResultBooks->location_building==0? "selected" : ""?>>A4 Chengdu</option>
					  <option value="1" <?php echo $ResultBooks->location_building==1? "selected" : ""?>>E2 Chengdu</option>
					</select>
				</div>
			</div>
			<div class="form-group">
		...
		<div class="form-group">
			...
			<div class="col-sm-7">
        	<button type="button" class="btn btn-info" onclick="ajaxSubmit('books_edit', 'dlgbody')"> &nbsp; Save &nbsp; </button>
